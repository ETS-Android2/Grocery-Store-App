...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    public interface TotalPrice{       //setting callback interfaces so deletion and calculation of total price are done in the cart fragment
                        ...
                        .setNegativeButton("No", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                try {
                                    ...
                                    deleteItem.onDeleteResult(items.get(position));    //calling the callback interface
